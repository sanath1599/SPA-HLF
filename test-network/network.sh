...
function networkUp() {
  ...
  IMAGE_TAG=$IMAGETAG docker-compose ${COMPOSE_FILES} up 2>&1
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    rm -rf organizations/fabric-ca/hdfc/msp organizations/fabric-ca/hdfc/tls-cert.pem organizations/fabric-ca/hdfc/ca-cert.pem organizations/fabric-ca/hdfc/IssuerPublicKey organizations/fabric-ca/hdfc/IssuerRevocationPublicKey organizations/fabric-ca/hdfc/fabric-ca-server.db
    rm -rf organizations/fabric-ca/sbi/msp organizations/fabric-ca/sbi/tls-cert.pem organizations/fabric-ca/sbi/ca-cert.pem organizations/fabric-ca/sbi/IssuerPublicKey organizations/fabric-ca/sbi/IssuerRevocationPublicKey organizations/fabric-ca/sbi/fabric-ca-server.db
    rm -rf organizations/fabric-ca/npci/msp organizations/fabric-ca/npci/tls-cert.pem organizations/fabric-ca/npci/ca-cert.pem organizations/fabric-ca/npci/IssuerPublicKey organizations/fabric-ca/npci/IssuerRevocationPublicKey organizations/fabric-ca/npci/fabric-ca-server.db
