...
export ORDERER1=orderer1.example.com
export ORDERER2=orderer2.example.com
...
export ORDERER1_CA=${PWD}/organizations/ordererOrganizations/example.com/orderers/${ORDERER1}/msp/tlscacerts/tlsca.example.com-cert.pem
export ORDERER2_CA=${PWD}/organizations/ordererOrganizations/example.com/orderers/${ORDERER2}/msp/tlscacerts/tlsca.example.com-cert.pem
